...
public class CobolDataEntry {
    ...
    private List < CobolDataEntry > _children = new LinkedList < CobolDataEntry >();
     ...
     */
    public List < CobolDataEntry > getChildren() {
        return _children;
    }
     ...
     */
    public void setChildren(final List < CobolDataEntry > children) {
        _children = children;
    }
