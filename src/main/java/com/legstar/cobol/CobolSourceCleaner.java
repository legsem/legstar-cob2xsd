...
public class CobolSourceCleaner {
    ...
    /** Default column where code starts (inclusive, based 1).*/
    public static final int DEFAULT_START_COLUMN = 7;
    
    /** Default column where code ends (inclusive, based 1).*/
    ...
    public String execute(
        ...
        return execute(cobolSource, DEFAULT_START_COLUMN, DEFAULT_END_COLUMN);
    }
            ...
            try {
                ...
                if (cleanedSource.length() <= LS.length()) {
                    throw new CleanerException(
                            "No data descriptions between columns " + startColumn
                            + " and " + endColumn + ". Are you sure this is COBOL source?");
                }
